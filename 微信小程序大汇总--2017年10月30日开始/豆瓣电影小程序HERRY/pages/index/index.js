...
Page({
  ...
  // },
  // getCache:function(){
  //   app.common._getStorage().then(function(){
  //     //这里写的是获取storage之后要做的事
  //       //判断获取的时间是否过期
  //   }).catch(function(){
  //     //这里写的是获取storage失败之后要做的事
  //       //也就是执行网络请求
  //   })
  // },
  getStorageParent:function(movies){
    app.comment.getStorage(movies).then(function(){
      console.log('获取sto成功')
    }).catch(function(){
      console.log('未获取成功')
    })
